...
return [
    ...
    | versiones, como las de tamaño. Siéntete libre de ajustarlas aquí.
    |
    */
    ...
    */
    ...
    | de posición de los atributos por algo más fácil de leer, como "Dirección de
    | correo electrónico" en lugar de "email". Esto ayuda a que los mensajes sean más claros.
    |
    */
