            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <form method="POST" action="{{ route('asesor.report.update') }}" class="space-y-6" id="reportForm" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="flex md:hidden items-center justify-between gap-3 bg-gray-50 dark:bg-gray-900/50 p-2 rounded-xl border border-gray-250 dark:border-gray-805">
                            ...
                            <input type="number" id="sign_captures_m" readonly value="{{ old('sign_captures', $report->sign_captures) }}" class="flex-1 text-center text-2xl font-black bg-transparent border-none focus:ring-0 text-gray-800 dark:text-gray-200">
                    ...
                    <div>
                        ...
                        <div class="flex md:hidden items-center justify-between gap-3 bg-gray-50 dark:bg-gray-900/50 p-2 rounded-xl border border-gray-250 dark:border-gray-805">
                            ...
                            <input type="number" id="exclusive_captures_m" readonly value="{{ old('exclusive_captures', $report->exclusive_captures) }}" class="flex-1 text-center text-2xl font-black bg-transparent border-none focus:ring-0 text-gray-800 dark:text-gray-200">
                    ...
                    <div>
                        ...
                        <div class="flex md:hidden items-center justify-between gap-3 bg-gray-50 dark:bg-gray-900/50 p-2 rounded-xl border border-gray-250 dark:border-gray-805">
                            ...
                            <input type="number" id="closings_m" readonly value="{{ old('closings', $report->closings) }}" class="flex-1 text-center text-2xl font-black bg-transparent border-none focus:ring-0 text-gray-800 dark:text-gray-200">
                    ...
                    <div>
                        ...
                        <div class="flex md:hidden items-center justify-between gap-3 bg-gray-50 dark:bg-gray-900/50 p-2 rounded-xl border border-gray-250 dark:border-gray-805">
                            ...
                            <input type="number" id="calls_made_m" readonly value="{{ old('calls_made', $report->calls_made) }}" class="flex-1 text-center text-2xl font-black bg-transparent border-none focus:ring-0 text-gray-800 dark:text-gray-200">
                    ...
                    <div>
                        ...
                        <div class="flex md:hidden items-center justify-between gap-3 bg-gray-50 dark:bg-gray-900/50 p-2 rounded-xl border border-gray-250 dark:border-gray-805">
                            ...
                            <input type="number" id="properties_in_system_m" readonly value="{{ old('properties_in_system', $report->properties_in_system) }}" class="flex-1 text-center text-2xl font-black bg-transparent border-none focus:ring-0 text-gray-800 dark:text-gray-200">
