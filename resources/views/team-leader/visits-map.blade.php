<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <a href="{{ route('team-leader.dashboard') }}" class="text-sm text-blue-600 hover:underline">← Volver</a>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mt-1">🗺️ Mapa de Visitas del Equipo</h2>
    ...
    <style>
        #team-map { height: 350px; border-radius: 1rem; z-index: 1; }
        @media (min-width: 768px) { #team-map { height: 520px; } }
    </style>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 print:hidden">
                <form method="GET" action="{{ route('team-leader.visits-map') }}" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            <a href="{{ route('team-leader.visits-map') }}" class="px-3 py-2.5 rounded-lg text-sm font-bold text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-center" title="Limpiar Filtros">
                                🧹
                            </a>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 text-center shadow-sm">
                    <p class="text-3xl font-black text-purple-600">{{ $asesoresCount }}</p>
                    <p class="text-xs text-gray-500 mt-1 uppercase font-bold">Asesores Activos</p>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 text-center shadow-sm">
                    <p class="text-3xl font-black text-amber-600">{{ $uniqueClients }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <div class="flex items-center gap-2 px-3 py-1.5 rounded-full border text-sm" style="border-color: {{ $color }}20; background-color: {{ $color }}15;">
            ...
            {{-- Mapa --}}
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
                <h3 class="text-lg font-bold text-gray-800 dark:text-gray-200 mb-3">🗺️ Mapa de Visitas del Equipo</h3>
                @if($geoVisits > 0)
                    <div id="team-map"></div>
                @else
                    <div class="flex flex-col items-center justify-center h-64 bg-gray-50 dark:bg-gray-700/30 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Tus asesores deben capturar GPS al registrar visitas.</p>
                    </div>
                @endif
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
                <h3 class="text-lg font-bold text-gray-800 dark:text-gray-200 mb-4">📋 Detalle de Todas las Visitas</h3>
    ...
    if (document.getElementById('team-map') && markers.length > 0) {
